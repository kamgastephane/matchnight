...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler({InvalidInputArgumentException.class, UserAlreadyExistException.class})
    ...
    private final ResponseEntity<BaseResponse> handleInvalidArgumentException(InvalidInputArgumentException ex) {
